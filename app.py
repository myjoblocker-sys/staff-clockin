...
TELEGRAM_BOTS = [
    ...
    },  # 👥 เจ บอทตัวที่ 2 (อย่าลืมใส่เครื่องหมายคอมม่าคั่นตรงท้ายบรรทัดนี้ด้วยนะครับ)
    {
        'token': 'ว่าง', 
        'chat_id': 'ว่าง'
    }   # 🤖 พี่เกรซ บอทตัวที่ 3 (ที่เพิ่มเข้ามาใหม่)
]
...
EMPLOYEE_DATA = {
    ...
    "261144": {"name": "นุรญา พิชาวรกิจ (เฟิร์น)", "branch": "มหาชัย"},
    "141138": {"name": "ธนินณัฎฐ์ ศรีแก้ว (แอน3)", "branch": "แสมดำ"},
    "240750": {"name": "ฟ้า", "branch": "มหาชัย"}
}
